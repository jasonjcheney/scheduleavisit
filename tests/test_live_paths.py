...
def main() -> None:
    ...
    # —— Public pages ——
    cases = [
        ("/", 200, ["Find a time — even when your clinician is full.", "I am a provider", "Clinician login", "Get your booking link", "Provider login", 'property="og:title"', "og:description"]),
